...
export const patient_forgot_password = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  try {
    ...
    const patient_user = await Patient.findOne({ where: { email } });
...
export const patient_reset_password = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  try {
    ...
    const patient_user = await Patient.findOne({
      where: {
