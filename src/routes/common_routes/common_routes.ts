...
router.get('/commonroute/export_all', celebrate(export_all_validation), authmiddleware, export_all)
router.get(
...
router.get('/commonroute/roles', celebrate(roles_validation), authmiddleware, roles)
