...
import { generate_confirmation_number, handle_request_state } from '../../utils'
import { Documents, Logs, RequestModel, User, Requestor, Notes, Order } from '../../db/models'
...
/**                              Admin in Dashboard                                       */
/**Admin SignUp */
export const admin_signup: Controller = async (req: Request, res: Response) => {
  try {
    const {
      body: {
        Email,
...
export const admin_create_request: Controller = async (req: Request, res: Response) => {
  try {
...
export const admin_create_request_verify: Controller = async (req: Request, res: Response) => {
  try {
    const { state } = req.body

    const valid_states = ['District Of Columbia', 'New York', 'Virginia', 'Maryland']
 ...
 */
export const manage_requests_by_State: Controller = async (req: Request, res: Response) => {
  try {
    ...
    switch (state) {
      ...
      case 'unpaid':
        return await handle_request_state(
          state === 'unpaid' ? ['date_of_service', 'physician_id', 'patient_id'] : undefined
        )
      default:
...
export const requests_by_request_state_counts: Controller = async (req: Request, res: Response) => {
  try {
    const request_state = ['new', 'pending', 'active', 'conclude', 'toclose', 'unpaid']
    const formatted_response: FormattedResponse<any> = {
      status: true,
      data: []
    }
...
export const requests_by_request_state_refactored: Controller = async (
  ...
  try {
    ...
    switch (state) {
      case 'new':
        return await handle_request_state(res, state, search, region, requestor, page, page_size)
      case 'pending':
      case 'active':
      case 'conclude':
        return await handle_request_state(res, state, search, region, requestor, page, page_size)
 ...
 */
export const view_notes_for_request: Controller = async (req: Request, res: Response) => {
  try {
...
export const save_view_notes_for_request: Controller = async (req: Request, res: Response) => {
  try {
    const { confirmation_no } = req.params
...
export const cancel_case_for_request: Controller = async (req: Request, res: Response) => {
  try {
    const { confirmation_no } = req.params
 ...
 */
export const assign_request_region_physician: Controller = async (req: Request, res: Response) => {
  try {
    const { confirmation_no } = req.params
...
export const assign_request: Controller = async (req: Request, res: Response) => {
  try {
    const { confirmation_no } = req.params
 ...
 */
export const block_case_for_request_view: Controller = async (req: Request, res: Response) => {
  try {
    const { confirmation_no } = req.params
    const formatted_response: FormattedResponse<any> = {
      status: true,
...
export const block_case_for_request_post: Controller = async (req: Request, res: Response) => {
  try {
    const { confirmation_no } = req.params
...
export const transfer_request: Controller = async (req: Request, res: Response) => {
  try {
    const { confirmation_no } = req.params
 ...
 */
export const clear_case_for_request: Controller = async (req: Request, res: Response) => {
  try {
    const { confirmation_no } = req.params
    try {
      const request = await RequestModel.findOne({
 ...
 */
export const close_case_for_request: Controller = async (req: Request, res: Response) => {
  try {
    const { confirmation_no } = req.params
    const request = await RequestModel.findOne({
      where: {
      ...
      include: [
        {
          as: 'Patient',
          model: User,
          attributes: ['user_id', 'firstname', 'lastname', 'dob', 'mobile_no', 'email']
        },
        {
          model: Documents,
...
export const close_case_for_request_edit: Controller = async (req: Request, res: Response) => {
  try {
    const { confirmation_no } = req.params
 ...
 */
export const request_support: Controller = async (req: Request, res: Response) => {
  try {
 ...
 */
export const admin_send_link: Controller = async (req: Request, res: Response) => {
  try {
