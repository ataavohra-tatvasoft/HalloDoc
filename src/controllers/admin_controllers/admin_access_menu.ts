...
import { User, RoleAccessMapping, Access, Role } from '../../db/models'
 ...
 */
export const access_accountaccess: Controller = async (req: Request, res: Response) => {
  try {
...
export const access_accountaccess_edit: Controller = async (req: Request, res: Response) => {
  try {
...
export const access_accountaccess_edit_save: Controller = async (req: Request, res: Response) => {
  try {
    const { role_id } = req.params
...
export const access_account_access_delete: Controller = async (req: Request, res: Response) => {
  try {
    const { role_id } = req.params
    ...
    return res.status(200).json({ status: true, message: message_constants.DS })
  } catch (error) {
    return res.status(500).json({ error: message_constants.ISE })
  }
}
...
export const access_useraccess: Controller = async (req: Request, res: Response) => {
  try {
...
export const access_useraccess_edit: Controller = async (req: Request, res: Response) => {
  try {
...
export const access_useraccess_edit_save: Controller = async (req: Request, res: Response) => {
  try {
    const { user_id } = req.params
    const { firstname, lastname, mobile_no, address_1, address_2, city, region, zip, dob } =
      req.body
    const account = await User.findOne({
      where: {
        user_id: user_id
