...
const provider_login = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (boolean) {
            providerdata = yield admin_1.default.findOne({
                where: {
                    email,
...
exports.provider_login = provider_login;
