...
const forgot_password = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const admin_user = yield admin_1.default.findOne({ where: { email } });
        const provider_user = yield provider_1.default.findOne({ where: { email } });
        ...
        if (provider_user) {
            yield provider_1.default.update({ reset_token: resetToken, reset_token_expiry: expireTime }, { where: { email } });
        }
...
const reset_password = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const admin_user = yield admin_1.default.findOne({
            where: {
                reset_token: ResetToken,
                reset_token_expiry: { [Op.gt]: Date.now() },
            },
        });
        const provider_user = yield provider_1.default.findOne({
            where: {
                reset_token: ResetToken,
                reset_token_expiry: { [Op.gt]: Date.now() },
            },
